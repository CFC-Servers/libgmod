...
--- @return Entity @A [phys_ragdollconstraint](https://developer.valvesoftware.com/wiki/Phys_ragdollconstraint) entity
...
--- @return Entity @The created constraint
...
--- @return Entity @The crated constraint
...
--- @param pos Vector @Position for the rope entity
...
--- @return Entity @The anchor entity
--- @return PhysObj @The achor entity's physics object
...
--- @param player Player @The player that will be able to control the constraint
--- @param ent1 Entity @First entity.
--- @param ent2 Entity @Second entity.
--- @param bone1 number @PhysObj number of first entity to constrain to
--- @param bone2 number @PhysObj number of second entity to constrain to
...
--- @return Entity @The created constraint
--- @return Entity @The crated rope
--- @return Entity @The muscle controller
--- @return Entity @The slider ([phys_slideconstraint](https://developer.valvesoftware.com/wiki/Phys_slideconstraint)) if `fixed` was exactly `1`
function constraint.Hydraulic(player, ent1, ent2, bone1, bone2, localPos1, localPos2, length1, length2, width, key, slider, speed, material, color)
end

---  server
--- Creates a keep upright constraint.  
--- ℹ **NOTE**: This function only works on prop_physics or prop_ragdoll. This restriction will be lifted in the next update.  
...
--- @param player? Player @The player that will control the motor
--- @param forcelimit? number @Amount of force until it breaks (0 = unbreakable)
...
--- @return Entity @The created constraint
--- @return Entity @The created axis constraint
...
--- @param worldPos2 Vector @World position constrain the first entity to
--- @param worldPos3 Vector @World position constrain the second entity to
--- @param forceLimit number @Amount of force until it breaks (0 = unbreakable)
...
--- @param color? table @The color of the rope
--- @return Entity @The created constraint
--- @return Entity @The first rope segment
--- @return Entity @The second rope segment
--- @return Entity @The third rope segment
...
--- @param material string @The material of the rope
--- @param color? table @The color of the rope
--- @return Entity @The created constraint entity
--- @return Entity @The created rope
...
--- @return Entity @The crated constraint entity
...
--- @return Entity @The created constraint
--- @return Entity @The crated rope
--- @return Entity @The winch controller

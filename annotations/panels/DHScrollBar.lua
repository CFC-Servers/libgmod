...
function DHScrollBar:AddScroll(add)
end
...
function DHScrollBar:AnimateTo(scroll, length, delay, ease)
end
...
function DHScrollBar:SetUp(barSize, canvasSize)
end

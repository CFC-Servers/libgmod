...
function DTextEntry:GetDisabled()
end
...
--- @deprecated
--- @return boolean 
function DTextEntry:GetDrawBackground()
end
...
--- @deprecated
--- @return boolean 
function DTextEntry:GetDrawBorder()
end
...
function DTextEntry:GetHighlightColor()
end
...
function DTextEntry:GetHistoryEnabled()
end
...
function DTextEntry:GetTabbingDisabled()
end
...
--- @param show boolean 
--- @deprecated
function DTextEntry:SetDrawBackground(show)
end
...
--- @param bool boolean 
--- @deprecated
function DTextEntry:SetDrawBorder(bool)
end
...
function DTextEntry:SetHighlightColor(color)
end

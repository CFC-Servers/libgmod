...
function CNewParticleEffect:GetRenderBounds()
end
...
function CNewParticleEffect:SetControlPointEntity(cpID, parent)
end
...
function CNewParticleEffect:SetControlPointParent(childID, parentID)
end

...
--- @param arg1 number @The constraint speed scale
function CMoveData:SetConstraintSpeedScale(arg1)
end

---  client|server
--- Sets  the width (distance from the edge of the radius, inward) where the actual movement constraint functions.  
--- @param arg1 number @The constraint width
function CMoveData:SetConstraintWidth(arg1)
end

...
function Entity:CreateBoneFollowers(bone_whitelist)
end
...
--- @param origin? Vector @The origin for the dissolve effect, its effect depends on the dissolve type
function Entity:Dissolve(type, magnitude, origin)
end
...
function Entity:GetFlexType(id)
end

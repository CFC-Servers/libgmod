...
--- @param arg1 string @The name of an activity, as defined in the model's `.qc` at compile time.
--- @return number @The ID of the activity
function util.GetActivityIDByName(arg1)
end
...
--- @param arg1 string @The name of an model animation event, as defined in the model's `.qc` at compile time.
--- @return number @The ID of an animation event, typically for usage with ENTITY:HandleAnimEvent.
function util.GetAnimEventNameByID(arg1)
end
...
--- ℹ **NOTE**: Clientside entities will not be hit by traces. This can be changed after next update.  

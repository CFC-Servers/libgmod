...
--- @source ../../garrysmod/garrysmod/lua/vgui/dscrollpanel.lua:33:37
...
--- @source ../../garrysmod/garrysmod/lua/vgui/dscrollpanel.lua:139:143
function DScrollPanel:Clear()
end

--- Returns the canvas ( The panel all child panels are parented to ) of the DScrollPanel.  
--- @source ../../garrysmod/garrysmod/lua/vgui/dscrollpanel.lua:57:61

...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:59:74
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:40:42
function cleanup.GetList()
end

--- Gets the table of cleanup types.  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:31:33
--- @return table @A list of cleanup types.
function cleanup.GetTable()
end

--- Registers a new cleanup type.  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:17:29
--- @param type string @Name of type.
function cleanup.Register(type)
end

--- Replaces one entity in the cleanup module with another  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:76:95
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/cleanup.lua:207:238

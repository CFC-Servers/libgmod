...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/hook.lua:23:42
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/hook.lua:74:137
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/hook.lua:15:21
--- @return table @A table of tables
function hook.GetTable()
end

--- Removes the hook with the supplied identifier from the given event.  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/hook.lua:45:61
...
--- </eventname>  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/hook.lua:64:71
--- @param eventName string @The event to call hooks for.
--- @param ... any ... @The arguments to be passed to the hooks.

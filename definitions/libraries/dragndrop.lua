...
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/client/panel/dragdrop.lua:12:25
function dragndrop.Clear()
end

--- Returns a table of currently dragged panels.  
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/client/panel/dragdrop.lua:168:179
...
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/client/panel/dragdrop.lua:35:41
function dragndrop.HandleDroppedInGame()
end

--- Returns whether the user is dragging something with the drag'n'drop system.  
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/client/panel/dragdrop.lua:27:33
...
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/client/panel/dragdrop.lua:119:135

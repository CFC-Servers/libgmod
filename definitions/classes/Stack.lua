...
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/util.lua:257:277
...
--- Pop an item from the stack  
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/util.lua:279:305
--- @param amount? number @Amount of items you want to pop.
...
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/util.lua:251:255
--- @param object any @The item you want to push
function Stack:Push(object)
end

--- Returns the size of the stack  
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/util.lua:317:319
--- @return number @The size of the stack
function Stack:Size()
end

--- Get the item at the top of the stack  
--- @source ../../garrysmod/garrysmod/lua/includes/extensions/util.lua:307:315

...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:36
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:56
...
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:67
function Task:IsEngineType()
end

--- Determines if the task is an NPC method-based task (`TYPE_FNAME`, 2).  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:75
function Task:IsFNameType()
end

--- Runs the AI task.  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:112
--- @param target NPC @The NPC to run the task on.
function Task:Run(target)
end

--- Starts the AI task.  
--- @source ../../garrysmod/garrysmod/lua/includes/modules/ai_task.lua:83
